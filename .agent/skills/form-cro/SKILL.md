...
- **Field Necessity & Efficiency** — Weight: 30
- **Value-Effort Balance** — Weight: 20
- **Cognitive Load & Clarity** — Weight: 20
- **Error Handling & Recovery** — Weight: 15
- **Trust & Friction Reduction** — Weight: 10
- **Mobile Usability** — Weight: 5
- **Total** — **100**
...
If a field is not used, not acted upon, or not required legally → it is friction, not value.
